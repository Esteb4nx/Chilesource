...
INSERT INTO chilesourcedb.post (post_id, post_title, post_body, post_date, post_category_id, author_id) VALUES (NULL, 'Codigo abierto hecho en Chile (Java)', '<h1>In eu turpis laoreet, ornare odio ut, tempor magna. Quisque tortor
...
INSERT INTO chilesourcedb.post (post_id, post_title, post_body, post_date, post_category_id, author_id) VALUES (NULL, 'Pruebas unitarias en JavaScript', '<pre>const Layout = (props) =&gt; (
  &lt;&gt;
    &lt;NextHead&gt;
...
INSERT INTO chilesourcedb.post (post_id, post_title, post_body, post_date, post_category_id, author_id) VALUES (NULL, 'Compilador en C', '<p>Morbi a feugiat massa, ac iaculis massa. Morbi vehicula dignissim
